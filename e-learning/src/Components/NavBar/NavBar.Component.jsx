          ...
          {/* Dropdown content */}
           <ul className="py-2 w-80 bg-gray-300 rounded-md ">
            ...
            <li className="px-4 py-2 text-gray-800 hover:bg-gray-200 cursor-pointer">
               <button className="text-white bg-blue-800 w-30  h-8 text-2xl rounded-md" onClick={openModal}>
          <span className="text-white  flex items-center  ml-3 mr-2 font-serif">
           Know More..
          </span>
    </button>
